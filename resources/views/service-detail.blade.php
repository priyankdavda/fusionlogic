        ...
        <section class="service-details pos-rel">
            <div class="container">
                                ...
                                <div class="xb-item--inner">
                                    ...
                                    @if(!empty($block['thumbnail']))
                                        <div class="xb-item--img xb-img">
                                            @for($i = 0; $i < 4; $i++)
                                                <a href="#!">
                                                     <img src="{{ rtrim(config('services.cms.asset_url'), '/') . '/storage/' . $block['thumbnail'] }}" alt="{{ $block['heading'] ?? 'service' }}" >
                                                </a>
                                            @endfor
                                        </div>
                                    @endif
                ...
                @if($service->features && count($service->features) > 0)
                    @foreach($service->features as $group)
                    <div class="services-outcome-wrap">
                        @if(!empty($group['title']))
                            <h2 class="details-content-title mb-15">{{ $group['title'] }}</h2>
                        @endif
                        ...
                        @if(!empty($group['subtitle']))
                            <h6 class="mt-20">{{ $group['subtitle'] }}</h6>
                        @endif
